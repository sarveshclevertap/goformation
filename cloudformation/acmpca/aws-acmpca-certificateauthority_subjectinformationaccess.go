...
type CertificateAuthority_SubjectInformationAccess struct {
...
func (r *CertificateAuthority_SubjectInformationAccess) AWSCloudFormationType() string {
	return "AWS::ACMPCA::CertificateAuthority.SubjectInformationAccess"
}
