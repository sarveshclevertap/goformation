...
type Certificate_GeneralNameList struct {

	// GeneralNameList AWS CloudFormation Property
	// Required: false
	...
	GeneralNameList []Certificate_GeneralName `json:"GeneralNameList,omitempty"`
...
func (r *Certificate_GeneralNameList) AWSCloudFormationType() string {
	return "AWS::ACMPCA::Certificate.GeneralNameList"
}
