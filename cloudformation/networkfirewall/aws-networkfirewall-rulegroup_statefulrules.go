...
// RuleGroup_StatefulRules AWS CloudFormation Resource (AWS::NetworkFirewall::RuleGroup.StatefulRules)
...
type RuleGroup_StatefulRules struct {
...
func (r *RuleGroup_StatefulRules) AWSCloudFormationType() string {
	return "AWS::NetworkFirewall::RuleGroup.StatefulRules"
}
