...
// FirewallPolicy_Tags AWS CloudFormation Resource (AWS::NetworkFirewall::FirewallPolicy.Tags)
...
func (r *FirewallPolicy_Tags) AWSCloudFormationType() string {
	return "AWS::NetworkFirewall::FirewallPolicy.Tags"
}
