...
import (
	"fmt"
	"github.com/wizrocket/goformation/v4/cloudformation/accessanalyzer"
	"github.com/wizrocket/goformation/v4/cloudformation/acmpca"
	"github.com/wizrocket/goformation/v4/cloudformation/amazonmq"
	"github.com/wizrocket/goformation/v4/cloudformation/amplify"
	"github.com/wizrocket/goformation/v4/cloudformation/apigateway"
	"github.com/wizrocket/goformation/v4/cloudformation/apigatewayv2"
	"github.com/wizrocket/goformation/v4/cloudformation/appconfig"
	"github.com/wizrocket/goformation/v4/cloudformation/appflow"
	"github.com/wizrocket/goformation/v4/cloudformation/appintegrations"
	"github.com/wizrocket/goformation/v4/cloudformation/applicationautoscaling"
	"github.com/wizrocket/goformation/v4/cloudformation/applicationinsights"
	"github.com/wizrocket/goformation/v4/cloudformation/appmesh"
	"github.com/wizrocket/goformation/v4/cloudformation/apprunner"
	"github.com/wizrocket/goformation/v4/cloudformation/appstream"
	"github.com/wizrocket/goformation/v4/cloudformation/appsync"
	"github.com/wizrocket/goformation/v4/cloudformation/ask"
	"github.com/wizrocket/goformation/v4/cloudformation/athena"
	"github.com/wizrocket/goformation/v4/cloudformation/auditmanager"
	"github.com/wizrocket/goformation/v4/cloudformation/autoscaling"
	"github.com/wizrocket/goformation/v4/cloudformation/autoscalingplans"
	"github.com/wizrocket/goformation/v4/cloudformation/backup"
	"github.com/wizrocket/goformation/v4/cloudformation/batch"
	"github.com/wizrocket/goformation/v4/cloudformation/budgets"
	"github.com/wizrocket/goformation/v4/cloudformation/cassandra"
	"github.com/wizrocket/goformation/v4/cloudformation/ce"
	"github.com/wizrocket/goformation/v4/cloudformation/certificatemanager"
	"github.com/wizrocket/goformation/v4/cloudformation/chatbot"
	"github.com/wizrocket/goformation/v4/cloudformation/cloud9"
	"github.com/wizrocket/goformation/v4/cloudformation/cloudformation"
	"github.com/wizrocket/goformation/v4/cloudformation/cloudfront"
	"github.com/wizrocket/goformation/v4/cloudformation/cloudtrail"
	"github.com/wizrocket/goformation/v4/cloudformation/cloudwatch"
	"github.com/wizrocket/goformation/v4/cloudformation/codeartifact"
	"github.com/wizrocket/goformation/v4/cloudformation/codebuild"
	"github.com/wizrocket/goformation/v4/cloudformation/codecommit"
	"github.com/wizrocket/goformation/v4/cloudformation/codedeploy"
	"github.com/wizrocket/goformation/v4/cloudformation/codeguruprofiler"
	"github.com/wizrocket/goformation/v4/cloudformation/codegurureviewer"
	"github.com/wizrocket/goformation/v4/cloudformation/codepipeline"
	"github.com/wizrocket/goformation/v4/cloudformation/codestar"
	"github.com/wizrocket/goformation/v4/cloudformation/codestarconnections"
	"github.com/wizrocket/goformation/v4/cloudformation/codestarnotifications"
	"github.com/wizrocket/goformation/v4/cloudformation/cognito"
	"github.com/wizrocket/goformation/v4/cloudformation/config"
	"github.com/wizrocket/goformation/v4/cloudformation/cur"
	"github.com/wizrocket/goformation/v4/cloudformation/customerprofiles"
	"github.com/wizrocket/goformation/v4/cloudformation/databrew"
	"github.com/wizrocket/goformation/v4/cloudformation/datapipeline"
	"github.com/wizrocket/goformation/v4/cloudformation/datasync"
	"github.com/wizrocket/goformation/v4/cloudformation/dax"
	"github.com/wizrocket/goformation/v4/cloudformation/detective"
	"github.com/wizrocket/goformation/v4/cloudformation/devopsguru"
	"github.com/wizrocket/goformation/v4/cloudformation/directoryservice"
	"github.com/wizrocket/goformation/v4/cloudformation/dlm"
	"github.com/wizrocket/goformation/v4/cloudformation/dms"
	"github.com/wizrocket/goformation/v4/cloudformation/docdb"
	"github.com/wizrocket/goformation/v4/cloudformation/dynamodb"
	"github.com/wizrocket/goformation/v4/cloudformation/ec2"
	"github.com/wizrocket/goformation/v4/cloudformation/ecr"
	"github.com/wizrocket/goformation/v4/cloudformation/ecs"
	"github.com/wizrocket/goformation/v4/cloudformation/efs"
	"github.com/wizrocket/goformation/v4/cloudformation/eks"
	"github.com/wizrocket/goformation/v4/cloudformation/elasticache"
	"github.com/wizrocket/goformation/v4/cloudformation/elasticbeanstalk"
	"github.com/wizrocket/goformation/v4/cloudformation/elasticloadbalancing"
	"github.com/wizrocket/goformation/v4/cloudformation/elasticloadbalancingv2"
	"github.com/wizrocket/goformation/v4/cloudformation/elasticsearch"
	"github.com/wizrocket/goformation/v4/cloudformation/emr"
	"github.com/wizrocket/goformation/v4/cloudformation/emrcontainers"
	"github.com/wizrocket/goformation/v4/cloudformation/events"
	"github.com/wizrocket/goformation/v4/cloudformation/eventschemas"
	"github.com/wizrocket/goformation/v4/cloudformation/finspace"
	"github.com/wizrocket/goformation/v4/cloudformation/fis"
	"github.com/wizrocket/goformation/v4/cloudformation/fms"
	"github.com/wizrocket/goformation/v4/cloudformation/frauddetector"
	"github.com/wizrocket/goformation/v4/cloudformation/fsx"
	"github.com/wizrocket/goformation/v4/cloudformation/gamelift"
	"github.com/wizrocket/goformation/v4/cloudformation/globalaccelerator"
	"github.com/wizrocket/goformation/v4/cloudformation/glue"
	"github.com/wizrocket/goformation/v4/cloudformation/greengrass"
	"github.com/wizrocket/goformation/v4/cloudformation/greengrassv2"
	"github.com/wizrocket/goformation/v4/cloudformation/groundstation"
	"github.com/wizrocket/goformation/v4/cloudformation/guardduty"
	"github.com/wizrocket/goformation/v4/cloudformation/iam"
	"github.com/wizrocket/goformation/v4/cloudformation/imagebuilder"
	"github.com/wizrocket/goformation/v4/cloudformation/inspector"
	"github.com/wizrocket/goformation/v4/cloudformation/iot"
	"github.com/wizrocket/goformation/v4/cloudformation/iot1click"
	"github.com/wizrocket/goformation/v4/cloudformation/iotanalytics"
	"github.com/wizrocket/goformation/v4/cloudformation/iotcoredeviceadvisor"
	"github.com/wizrocket/goformation/v4/cloudformation/iotevents"
	"github.com/wizrocket/goformation/v4/cloudformation/iotfleethub"
	"github.com/wizrocket/goformation/v4/cloudformation/iotsitewise"
	"github.com/wizrocket/goformation/v4/cloudformation/iotthingsgraph"
	"github.com/wizrocket/goformation/v4/cloudformation/iotwireless"
	"github.com/wizrocket/goformation/v4/cloudformation/ivs"
	"github.com/wizrocket/goformation/v4/cloudformation/kendra"
	"github.com/wizrocket/goformation/v4/cloudformation/kinesis"
	"github.com/wizrocket/goformation/v4/cloudformation/kinesisanalytics"
	"github.com/wizrocket/goformation/v4/cloudformation/kinesisanalyticsv2"
	"github.com/wizrocket/goformation/v4/cloudformation/kinesisfirehose"
	"github.com/wizrocket/goformation/v4/cloudformation/kms"
	"github.com/wizrocket/goformation/v4/cloudformation/lakeformation"
	"github.com/wizrocket/goformation/v4/cloudformation/lambda"
	"github.com/wizrocket/goformation/v4/cloudformation/licensemanager"
	"github.com/wizrocket/goformation/v4/cloudformation/location"
	"github.com/wizrocket/goformation/v4/cloudformation/logs"
	"github.com/wizrocket/goformation/v4/cloudformation/lookoutmetrics"
	"github.com/wizrocket/goformation/v4/cloudformation/lookoutvision"
	"github.com/wizrocket/goformation/v4/cloudformation/macie"
	"github.com/wizrocket/goformation/v4/cloudformation/managedblockchain"
	"github.com/wizrocket/goformation/v4/cloudformation/mediaconnect"
	"github.com/wizrocket/goformation/v4/cloudformation/mediaconvert"
	"github.com/wizrocket/goformation/v4/cloudformation/medialive"
	"github.com/wizrocket/goformation/v4/cloudformation/mediapackage"
	"github.com/wizrocket/goformation/v4/cloudformation/mediastore"
	"github.com/wizrocket/goformation/v4/cloudformation/msk"
	"github.com/wizrocket/goformation/v4/cloudformation/mwaa"
	"github.com/wizrocket/goformation/v4/cloudformation/neptune"
	"github.com/wizrocket/goformation/v4/cloudformation/networkfirewall"
	"github.com/wizrocket/goformation/v4/cloudformation/networkmanager"
	"github.com/wizrocket/goformation/v4/cloudformation/nimblestudio"
	"github.com/wizrocket/goformation/v4/cloudformation/opsworks"
	"github.com/wizrocket/goformation/v4/cloudformation/opsworkscm"
	"github.com/wizrocket/goformation/v4/cloudformation/pinpoint"
	"github.com/wizrocket/goformation/v4/cloudformation/pinpointemail"
	"github.com/wizrocket/goformation/v4/cloudformation/qldb"
	"github.com/wizrocket/goformation/v4/cloudformation/quicksight"
	"github.com/wizrocket/goformation/v4/cloudformation/ram"
	"github.com/wizrocket/goformation/v4/cloudformation/rds"
	"github.com/wizrocket/goformation/v4/cloudformation/redshift"
	"github.com/wizrocket/goformation/v4/cloudformation/resourcegroups"
	"github.com/wizrocket/goformation/v4/cloudformation/robomaker"
	"github.com/wizrocket/goformation/v4/cloudformation/route53"
	"github.com/wizrocket/goformation/v4/cloudformation/route53resolver"
	"github.com/wizrocket/goformation/v4/cloudformation/s3"
	"github.com/wizrocket/goformation/v4/cloudformation/s3objectlambda"
	"github.com/wizrocket/goformation/v4/cloudformation/s3outposts"
	"github.com/wizrocket/goformation/v4/cloudformation/sagemaker"
	"github.com/wizrocket/goformation/v4/cloudformation/sdb"
	"github.com/wizrocket/goformation/v4/cloudformation/secretsmanager"
	"github.com/wizrocket/goformation/v4/cloudformation/securityhub"
	"github.com/wizrocket/goformation/v4/cloudformation/serverless"
	"github.com/wizrocket/goformation/v4/cloudformation/servicecatalog"
	"github.com/wizrocket/goformation/v4/cloudformation/servicecatalogappregistry"
	"github.com/wizrocket/goformation/v4/cloudformation/servicediscovery"
	"github.com/wizrocket/goformation/v4/cloudformation/ses"
	"github.com/wizrocket/goformation/v4/cloudformation/signer"
	"github.com/wizrocket/goformation/v4/cloudformation/sns"
	"github.com/wizrocket/goformation/v4/cloudformation/sqs"
	"github.com/wizrocket/goformation/v4/cloudformation/ssm"
	"github.com/wizrocket/goformation/v4/cloudformation/ssmcontacts"
	"github.com/wizrocket/goformation/v4/cloudformation/ssmincidents"
	"github.com/wizrocket/goformation/v4/cloudformation/sso"
	"github.com/wizrocket/goformation/v4/cloudformation/stepfunctions"
	"github.com/wizrocket/goformation/v4/cloudformation/synthetics"
	"github.com/wizrocket/goformation/v4/cloudformation/timestream"
	"github.com/wizrocket/goformation/v4/cloudformation/transfer"
	"github.com/wizrocket/goformation/v4/cloudformation/waf"
	"github.com/wizrocket/goformation/v4/cloudformation/wafregional"
	"github.com/wizrocket/goformation/v4/cloudformation/wafv2"
	"github.com/wizrocket/goformation/v4/cloudformation/workspaces"
	"github.com/wizrocket/goformation/v4/cloudformation/xray"
)
