...
import (
	"fmt"
	"github.com/dexty007/goformation/v4/cloudformation/accessanalyzer"
	"github.com/dexty007/goformation/v4/cloudformation/acmpca"
	"github.com/dexty007/goformation/v4/cloudformation/amazonmq"
	"github.com/dexty007/goformation/v4/cloudformation/amplify"
	"github.com/dexty007/goformation/v4/cloudformation/apigateway"
	"github.com/dexty007/goformation/v4/cloudformation/apigatewayv2"
	"github.com/dexty007/goformation/v4/cloudformation/appconfig"
	"github.com/dexty007/goformation/v4/cloudformation/appflow"
	"github.com/dexty007/goformation/v4/cloudformation/appintegrations"
	"github.com/dexty007/goformation/v4/cloudformation/applicationautoscaling"
	"github.com/dexty007/goformation/v4/cloudformation/applicationinsights"
	"github.com/dexty007/goformation/v4/cloudformation/appmesh"
	"github.com/dexty007/goformation/v4/cloudformation/apprunner"
	"github.com/dexty007/goformation/v4/cloudformation/appstream"
	"github.com/dexty007/goformation/v4/cloudformation/appsync"
	"github.com/dexty007/goformation/v4/cloudformation/ask"
	"github.com/dexty007/goformation/v4/cloudformation/athena"
	"github.com/dexty007/goformation/v4/cloudformation/auditmanager"
	"github.com/dexty007/goformation/v4/cloudformation/autoscaling"
	"github.com/dexty007/goformation/v4/cloudformation/autoscalingplans"
	"github.com/dexty007/goformation/v4/cloudformation/backup"
	"github.com/dexty007/goformation/v4/cloudformation/batch"
	"github.com/dexty007/goformation/v4/cloudformation/budgets"
	"github.com/dexty007/goformation/v4/cloudformation/cassandra"
	"github.com/dexty007/goformation/v4/cloudformation/ce"
	"github.com/dexty007/goformation/v4/cloudformation/certificatemanager"
	"github.com/dexty007/goformation/v4/cloudformation/chatbot"
	"github.com/dexty007/goformation/v4/cloudformation/cloud9"
	"github.com/dexty007/goformation/v4/cloudformation/cloudformation"
	"github.com/dexty007/goformation/v4/cloudformation/cloudfront"
	"github.com/dexty007/goformation/v4/cloudformation/cloudtrail"
	"github.com/dexty007/goformation/v4/cloudformation/cloudwatch"
	"github.com/dexty007/goformation/v4/cloudformation/codeartifact"
	"github.com/dexty007/goformation/v4/cloudformation/codebuild"
	"github.com/dexty007/goformation/v4/cloudformation/codecommit"
	"github.com/dexty007/goformation/v4/cloudformation/codedeploy"
	"github.com/dexty007/goformation/v4/cloudformation/codeguruprofiler"
	"github.com/dexty007/goformation/v4/cloudformation/codegurureviewer"
	"github.com/dexty007/goformation/v4/cloudformation/codepipeline"
	"github.com/dexty007/goformation/v4/cloudformation/codestar"
	"github.com/dexty007/goformation/v4/cloudformation/codestarconnections"
	"github.com/dexty007/goformation/v4/cloudformation/codestarnotifications"
	"github.com/dexty007/goformation/v4/cloudformation/cognito"
	"github.com/dexty007/goformation/v4/cloudformation/config"
	"github.com/dexty007/goformation/v4/cloudformation/cur"
	"github.com/dexty007/goformation/v4/cloudformation/customerprofiles"
	"github.com/dexty007/goformation/v4/cloudformation/databrew"
	"github.com/dexty007/goformation/v4/cloudformation/datapipeline"
	"github.com/dexty007/goformation/v4/cloudformation/datasync"
	"github.com/dexty007/goformation/v4/cloudformation/dax"
	"github.com/dexty007/goformation/v4/cloudformation/detective"
	"github.com/dexty007/goformation/v4/cloudformation/devopsguru"
	"github.com/dexty007/goformation/v4/cloudformation/directoryservice"
	"github.com/dexty007/goformation/v4/cloudformation/dlm"
	"github.com/dexty007/goformation/v4/cloudformation/dms"
	"github.com/dexty007/goformation/v4/cloudformation/docdb"
	"github.com/dexty007/goformation/v4/cloudformation/dynamodb"
	"github.com/dexty007/goformation/v4/cloudformation/ec2"
	"github.com/dexty007/goformation/v4/cloudformation/ecr"
	"github.com/dexty007/goformation/v4/cloudformation/ecs"
	"github.com/dexty007/goformation/v4/cloudformation/efs"
	"github.com/dexty007/goformation/v4/cloudformation/eks"
	"github.com/dexty007/goformation/v4/cloudformation/elasticache"
	"github.com/dexty007/goformation/v4/cloudformation/elasticbeanstalk"
	"github.com/dexty007/goformation/v4/cloudformation/elasticloadbalancing"
	"github.com/dexty007/goformation/v4/cloudformation/elasticloadbalancingv2"
	"github.com/dexty007/goformation/v4/cloudformation/elasticsearch"
	"github.com/dexty007/goformation/v4/cloudformation/emr"
	"github.com/dexty007/goformation/v4/cloudformation/emrcontainers"
	"github.com/dexty007/goformation/v4/cloudformation/events"
	"github.com/dexty007/goformation/v4/cloudformation/eventschemas"
	"github.com/dexty007/goformation/v4/cloudformation/finspace"
	"github.com/dexty007/goformation/v4/cloudformation/fis"
	"github.com/dexty007/goformation/v4/cloudformation/fms"
	"github.com/dexty007/goformation/v4/cloudformation/frauddetector"
	"github.com/dexty007/goformation/v4/cloudformation/fsx"
	"github.com/dexty007/goformation/v4/cloudformation/gamelift"
	"github.com/dexty007/goformation/v4/cloudformation/globalaccelerator"
	"github.com/dexty007/goformation/v4/cloudformation/glue"
	"github.com/dexty007/goformation/v4/cloudformation/greengrass"
	"github.com/dexty007/goformation/v4/cloudformation/greengrassv2"
	"github.com/dexty007/goformation/v4/cloudformation/groundstation"
	"github.com/dexty007/goformation/v4/cloudformation/guardduty"
	"github.com/dexty007/goformation/v4/cloudformation/iam"
	"github.com/dexty007/goformation/v4/cloudformation/imagebuilder"
	"github.com/dexty007/goformation/v4/cloudformation/inspector"
	"github.com/dexty007/goformation/v4/cloudformation/iot"
	"github.com/dexty007/goformation/v4/cloudformation/iot1click"
	"github.com/dexty007/goformation/v4/cloudformation/iotanalytics"
	"github.com/dexty007/goformation/v4/cloudformation/iotcoredeviceadvisor"
	"github.com/dexty007/goformation/v4/cloudformation/iotevents"
	"github.com/dexty007/goformation/v4/cloudformation/iotfleethub"
	"github.com/dexty007/goformation/v4/cloudformation/iotsitewise"
	"github.com/dexty007/goformation/v4/cloudformation/iotthingsgraph"
	"github.com/dexty007/goformation/v4/cloudformation/iotwireless"
	"github.com/dexty007/goformation/v4/cloudformation/ivs"
	"github.com/dexty007/goformation/v4/cloudformation/kendra"
	"github.com/dexty007/goformation/v4/cloudformation/kinesis"
	"github.com/dexty007/goformation/v4/cloudformation/kinesisanalytics"
	"github.com/dexty007/goformation/v4/cloudformation/kinesisanalyticsv2"
	"github.com/dexty007/goformation/v4/cloudformation/kinesisfirehose"
	"github.com/dexty007/goformation/v4/cloudformation/kms"
	"github.com/dexty007/goformation/v4/cloudformation/lakeformation"
	"github.com/dexty007/goformation/v4/cloudformation/lambda"
	"github.com/dexty007/goformation/v4/cloudformation/licensemanager"
	"github.com/dexty007/goformation/v4/cloudformation/location"
	"github.com/dexty007/goformation/v4/cloudformation/logs"
	"github.com/dexty007/goformation/v4/cloudformation/lookoutmetrics"
	"github.com/dexty007/goformation/v4/cloudformation/lookoutvision"
	"github.com/dexty007/goformation/v4/cloudformation/macie"
	"github.com/dexty007/goformation/v4/cloudformation/managedblockchain"
	"github.com/dexty007/goformation/v4/cloudformation/mediaconnect"
	"github.com/dexty007/goformation/v4/cloudformation/mediaconvert"
	"github.com/dexty007/goformation/v4/cloudformation/medialive"
	"github.com/dexty007/goformation/v4/cloudformation/mediapackage"
	"github.com/dexty007/goformation/v4/cloudformation/mediastore"
	"github.com/dexty007/goformation/v4/cloudformation/msk"
	"github.com/dexty007/goformation/v4/cloudformation/mwaa"
	"github.com/dexty007/goformation/v4/cloudformation/neptune"
	"github.com/dexty007/goformation/v4/cloudformation/networkfirewall"
	"github.com/dexty007/goformation/v4/cloudformation/networkmanager"
	"github.com/dexty007/goformation/v4/cloudformation/nimblestudio"
	"github.com/dexty007/goformation/v4/cloudformation/opsworks"
	"github.com/dexty007/goformation/v4/cloudformation/opsworkscm"
	"github.com/dexty007/goformation/v4/cloudformation/pinpoint"
	"github.com/dexty007/goformation/v4/cloudformation/pinpointemail"
	"github.com/dexty007/goformation/v4/cloudformation/qldb"
	"github.com/dexty007/goformation/v4/cloudformation/quicksight"
	"github.com/dexty007/goformation/v4/cloudformation/ram"
	"github.com/dexty007/goformation/v4/cloudformation/rds"
	"github.com/dexty007/goformation/v4/cloudformation/redshift"
	"github.com/dexty007/goformation/v4/cloudformation/resourcegroups"
	"github.com/dexty007/goformation/v4/cloudformation/robomaker"
	"github.com/dexty007/goformation/v4/cloudformation/route53"
	"github.com/dexty007/goformation/v4/cloudformation/route53resolver"
	"github.com/dexty007/goformation/v4/cloudformation/s3"
	"github.com/dexty007/goformation/v4/cloudformation/s3objectlambda"
	"github.com/dexty007/goformation/v4/cloudformation/s3outposts"
	"github.com/dexty007/goformation/v4/cloudformation/sagemaker"
	"github.com/dexty007/goformation/v4/cloudformation/sdb"
	"github.com/dexty007/goformation/v4/cloudformation/secretsmanager"
	"github.com/dexty007/goformation/v4/cloudformation/securityhub"
	"github.com/dexty007/goformation/v4/cloudformation/serverless"
	"github.com/dexty007/goformation/v4/cloudformation/servicecatalog"
	"github.com/dexty007/goformation/v4/cloudformation/servicecatalogappregistry"
	"github.com/dexty007/goformation/v4/cloudformation/servicediscovery"
	"github.com/dexty007/goformation/v4/cloudformation/ses"
	"github.com/dexty007/goformation/v4/cloudformation/signer"
	"github.com/dexty007/goformation/v4/cloudformation/sns"
	"github.com/dexty007/goformation/v4/cloudformation/sqs"
	"github.com/dexty007/goformation/v4/cloudformation/ssm"
	"github.com/dexty007/goformation/v4/cloudformation/ssmcontacts"
	"github.com/dexty007/goformation/v4/cloudformation/ssmincidents"
	"github.com/dexty007/goformation/v4/cloudformation/sso"
	"github.com/dexty007/goformation/v4/cloudformation/stepfunctions"
	"github.com/dexty007/goformation/v4/cloudformation/synthetics"
	"github.com/dexty007/goformation/v4/cloudformation/timestream"
	"github.com/dexty007/goformation/v4/cloudformation/transfer"
	"github.com/dexty007/goformation/v4/cloudformation/waf"
	"github.com/dexty007/goformation/v4/cloudformation/wafregional"
	"github.com/dexty007/goformation/v4/cloudformation/wafv2"
	"github.com/dexty007/goformation/v4/cloudformation/workspaces"
	"github.com/dexty007/goformation/v4/cloudformation/xray"
)
