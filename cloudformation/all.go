...
import (
	"fmt"
	"github.com/anurocks1/goformation/v4/cloudformation/accessanalyzer"
	"github.com/anurocks1/goformation/v4/cloudformation/acmpca"
	"github.com/anurocks1/goformation/v4/cloudformation/amazonmq"
	"github.com/anurocks1/goformation/v4/cloudformation/amplify"
	"github.com/anurocks1/goformation/v4/cloudformation/apigateway"
	"github.com/anurocks1/goformation/v4/cloudformation/apigatewayv2"
	"github.com/anurocks1/goformation/v4/cloudformation/appconfig"
	"github.com/anurocks1/goformation/v4/cloudformation/appflow"
	"github.com/anurocks1/goformation/v4/cloudformation/appintegrations"
	"github.com/anurocks1/goformation/v4/cloudformation/applicationautoscaling"
	"github.com/anurocks1/goformation/v4/cloudformation/applicationinsights"
	"github.com/anurocks1/goformation/v4/cloudformation/appmesh"
	"github.com/anurocks1/goformation/v4/cloudformation/apprunner"
	"github.com/anurocks1/goformation/v4/cloudformation/appstream"
	"github.com/anurocks1/goformation/v4/cloudformation/appsync"
	"github.com/anurocks1/goformation/v4/cloudformation/ask"
	"github.com/anurocks1/goformation/v4/cloudformation/athena"
	"github.com/anurocks1/goformation/v4/cloudformation/auditmanager"
	"github.com/anurocks1/goformation/v4/cloudformation/autoscaling"
	"github.com/anurocks1/goformation/v4/cloudformation/autoscalingplans"
	"github.com/anurocks1/goformation/v4/cloudformation/backup"
	"github.com/anurocks1/goformation/v4/cloudformation/batch"
	"github.com/anurocks1/goformation/v4/cloudformation/budgets"
	"github.com/anurocks1/goformation/v4/cloudformation/cassandra"
	"github.com/anurocks1/goformation/v4/cloudformation/ce"
	"github.com/anurocks1/goformation/v4/cloudformation/certificatemanager"
	"github.com/anurocks1/goformation/v4/cloudformation/chatbot"
	"github.com/anurocks1/goformation/v4/cloudformation/cloud9"
	"github.com/anurocks1/goformation/v4/cloudformation/cloudformation"
	"github.com/anurocks1/goformation/v4/cloudformation/cloudfront"
	"github.com/anurocks1/goformation/v4/cloudformation/cloudtrail"
	"github.com/anurocks1/goformation/v4/cloudformation/cloudwatch"
	"github.com/anurocks1/goformation/v4/cloudformation/codeartifact"
	"github.com/anurocks1/goformation/v4/cloudformation/codebuild"
	"github.com/anurocks1/goformation/v4/cloudformation/codecommit"
	"github.com/anurocks1/goformation/v4/cloudformation/codedeploy"
	"github.com/anurocks1/goformation/v4/cloudformation/codeguruprofiler"
	"github.com/anurocks1/goformation/v4/cloudformation/codegurureviewer"
	"github.com/anurocks1/goformation/v4/cloudformation/codepipeline"
	"github.com/anurocks1/goformation/v4/cloudformation/codestar"
	"github.com/anurocks1/goformation/v4/cloudformation/codestarconnections"
	"github.com/anurocks1/goformation/v4/cloudformation/codestarnotifications"
	"github.com/anurocks1/goformation/v4/cloudformation/cognito"
	"github.com/anurocks1/goformation/v4/cloudformation/config"
	"github.com/anurocks1/goformation/v4/cloudformation/cur"
	"github.com/anurocks1/goformation/v4/cloudformation/customerprofiles"
	"github.com/anurocks1/goformation/v4/cloudformation/databrew"
	"github.com/anurocks1/goformation/v4/cloudformation/datapipeline"
	"github.com/anurocks1/goformation/v4/cloudformation/datasync"
	"github.com/anurocks1/goformation/v4/cloudformation/dax"
	"github.com/anurocks1/goformation/v4/cloudformation/detective"
	"github.com/anurocks1/goformation/v4/cloudformation/devopsguru"
	"github.com/anurocks1/goformation/v4/cloudformation/directoryservice"
	"github.com/anurocks1/goformation/v4/cloudformation/dlm"
	"github.com/anurocks1/goformation/v4/cloudformation/dms"
	"github.com/anurocks1/goformation/v4/cloudformation/docdb"
	"github.com/anurocks1/goformation/v4/cloudformation/dynamodb"
	"github.com/anurocks1/goformation/v4/cloudformation/ec2"
	"github.com/anurocks1/goformation/v4/cloudformation/ecr"
	"github.com/anurocks1/goformation/v4/cloudformation/ecs"
	"github.com/anurocks1/goformation/v4/cloudformation/efs"
	"github.com/anurocks1/goformation/v4/cloudformation/eks"
	"github.com/anurocks1/goformation/v4/cloudformation/elasticache"
	"github.com/anurocks1/goformation/v4/cloudformation/elasticbeanstalk"
	"github.com/anurocks1/goformation/v4/cloudformation/elasticloadbalancing"
	"github.com/anurocks1/goformation/v4/cloudformation/elasticloadbalancingv2"
	"github.com/anurocks1/goformation/v4/cloudformation/elasticsearch"
	"github.com/anurocks1/goformation/v4/cloudformation/emr"
	"github.com/anurocks1/goformation/v4/cloudformation/emrcontainers"
	"github.com/anurocks1/goformation/v4/cloudformation/events"
	"github.com/anurocks1/goformation/v4/cloudformation/eventschemas"
	"github.com/anurocks1/goformation/v4/cloudformation/finspace"
	"github.com/anurocks1/goformation/v4/cloudformation/fis"
	"github.com/anurocks1/goformation/v4/cloudformation/fms"
	"github.com/anurocks1/goformation/v4/cloudformation/frauddetector"
	"github.com/anurocks1/goformation/v4/cloudformation/fsx"
	"github.com/anurocks1/goformation/v4/cloudformation/gamelift"
	"github.com/anurocks1/goformation/v4/cloudformation/globalaccelerator"
	"github.com/anurocks1/goformation/v4/cloudformation/glue"
	"github.com/anurocks1/goformation/v4/cloudformation/greengrass"
	"github.com/anurocks1/goformation/v4/cloudformation/greengrassv2"
	"github.com/anurocks1/goformation/v4/cloudformation/groundstation"
	"github.com/anurocks1/goformation/v4/cloudformation/guardduty"
	"github.com/anurocks1/goformation/v4/cloudformation/iam"
	"github.com/anurocks1/goformation/v4/cloudformation/imagebuilder"
	"github.com/anurocks1/goformation/v4/cloudformation/inspector"
	"github.com/anurocks1/goformation/v4/cloudformation/iot"
	"github.com/anurocks1/goformation/v4/cloudformation/iot1click"
	"github.com/anurocks1/goformation/v4/cloudformation/iotanalytics"
	"github.com/anurocks1/goformation/v4/cloudformation/iotcoredeviceadvisor"
	"github.com/anurocks1/goformation/v4/cloudformation/iotevents"
	"github.com/anurocks1/goformation/v4/cloudformation/iotfleethub"
	"github.com/anurocks1/goformation/v4/cloudformation/iotsitewise"
	"github.com/anurocks1/goformation/v4/cloudformation/iotthingsgraph"
	"github.com/anurocks1/goformation/v4/cloudformation/iotwireless"
	"github.com/anurocks1/goformation/v4/cloudformation/ivs"
	"github.com/anurocks1/goformation/v4/cloudformation/kendra"
	"github.com/anurocks1/goformation/v4/cloudformation/kinesis"
	"github.com/anurocks1/goformation/v4/cloudformation/kinesisanalytics"
	"github.com/anurocks1/goformation/v4/cloudformation/kinesisanalyticsv2"
	"github.com/anurocks1/goformation/v4/cloudformation/kinesisfirehose"
	"github.com/anurocks1/goformation/v4/cloudformation/kms"
	"github.com/anurocks1/goformation/v4/cloudformation/lakeformation"
	"github.com/anurocks1/goformation/v4/cloudformation/lambda"
	"github.com/anurocks1/goformation/v4/cloudformation/licensemanager"
	"github.com/anurocks1/goformation/v4/cloudformation/location"
	"github.com/anurocks1/goformation/v4/cloudformation/logs"
	"github.com/anurocks1/goformation/v4/cloudformation/lookoutmetrics"
	"github.com/anurocks1/goformation/v4/cloudformation/lookoutvision"
	"github.com/anurocks1/goformation/v4/cloudformation/macie"
	"github.com/anurocks1/goformation/v4/cloudformation/managedblockchain"
	"github.com/anurocks1/goformation/v4/cloudformation/mediaconnect"
	"github.com/anurocks1/goformation/v4/cloudformation/mediaconvert"
	"github.com/anurocks1/goformation/v4/cloudformation/medialive"
	"github.com/anurocks1/goformation/v4/cloudformation/mediapackage"
	"github.com/anurocks1/goformation/v4/cloudformation/mediastore"
	"github.com/anurocks1/goformation/v4/cloudformation/msk"
	"github.com/anurocks1/goformation/v4/cloudformation/mwaa"
	"github.com/anurocks1/goformation/v4/cloudformation/neptune"
	"github.com/anurocks1/goformation/v4/cloudformation/networkfirewall"
	"github.com/anurocks1/goformation/v4/cloudformation/networkmanager"
	"github.com/anurocks1/goformation/v4/cloudformation/nimblestudio"
	"github.com/anurocks1/goformation/v4/cloudformation/opsworks"
	"github.com/anurocks1/goformation/v4/cloudformation/opsworkscm"
	"github.com/anurocks1/goformation/v4/cloudformation/pinpoint"
	"github.com/anurocks1/goformation/v4/cloudformation/pinpointemail"
	"github.com/anurocks1/goformation/v4/cloudformation/qldb"
	"github.com/anurocks1/goformation/v4/cloudformation/quicksight"
	"github.com/anurocks1/goformation/v4/cloudformation/ram"
	"github.com/anurocks1/goformation/v4/cloudformation/rds"
	"github.com/anurocks1/goformation/v4/cloudformation/redshift"
	"github.com/anurocks1/goformation/v4/cloudformation/resourcegroups"
	"github.com/anurocks1/goformation/v4/cloudformation/robomaker"
	"github.com/anurocks1/goformation/v4/cloudformation/route53"
	"github.com/anurocks1/goformation/v4/cloudformation/route53resolver"
	"github.com/anurocks1/goformation/v4/cloudformation/s3"
	"github.com/anurocks1/goformation/v4/cloudformation/s3objectlambda"
	"github.com/anurocks1/goformation/v4/cloudformation/s3outposts"
	"github.com/anurocks1/goformation/v4/cloudformation/sagemaker"
	"github.com/anurocks1/goformation/v4/cloudformation/sdb"
	"github.com/anurocks1/goformation/v4/cloudformation/secretsmanager"
	"github.com/anurocks1/goformation/v4/cloudformation/securityhub"
	"github.com/anurocks1/goformation/v4/cloudformation/serverless"
	"github.com/anurocks1/goformation/v4/cloudformation/servicecatalog"
	"github.com/anurocks1/goformation/v4/cloudformation/servicecatalogappregistry"
	"github.com/anurocks1/goformation/v4/cloudformation/servicediscovery"
	"github.com/anurocks1/goformation/v4/cloudformation/ses"
	"github.com/anurocks1/goformation/v4/cloudformation/signer"
	"github.com/anurocks1/goformation/v4/cloudformation/sns"
	"github.com/anurocks1/goformation/v4/cloudformation/sqs"
	"github.com/anurocks1/goformation/v4/cloudformation/ssm"
	"github.com/anurocks1/goformation/v4/cloudformation/ssmcontacts"
	"github.com/anurocks1/goformation/v4/cloudformation/ssmincidents"
	"github.com/anurocks1/goformation/v4/cloudformation/sso"
	"github.com/anurocks1/goformation/v4/cloudformation/stepfunctions"
	"github.com/anurocks1/goformation/v4/cloudformation/synthetics"
	"github.com/anurocks1/goformation/v4/cloudformation/timestream"
	"github.com/anurocks1/goformation/v4/cloudformation/transfer"
	"github.com/anurocks1/goformation/v4/cloudformation/waf"
	"github.com/anurocks1/goformation/v4/cloudformation/wafregional"
	"github.com/anurocks1/goformation/v4/cloudformation/wafv2"
	"github.com/anurocks1/goformation/v4/cloudformation/workspaces"
	"github.com/anurocks1/goformation/v4/cloudformation/xray"
)
